		...
		<div className="relative px-4 py-10 bg-white shadow-lg sm:rounded-3xl sm:p-20">
			<div className="max-w-md mx-auto">
				...
				<div className="divide-y divide-gray-200">
					<form onSubmit={handleLogin} className="py-8 text-base leading-6 space-y-4 text-gray-700 sm:text-lg sm:leading-7">
						...
						</div>
                      {
                        ...
                        <p>
                            If you haven't an account. Please <Link to="/sign-up" className='text-blue-600 underline'>  Sign up</Link> Here
                        </p>
						<div className="relative">
                ...
                <div className='flex w-full items-center flex-col mt-5 gap-3'>
                    <button onClick={handleRegister} className='block'><img src={googleLogo} className='w-12 h-12 inline-block' alt="" />Login with Google</button>
                </div>
			</div>
		</div>
	</div>
